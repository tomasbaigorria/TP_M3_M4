...
- A continuación, visualizamos algunas variables categóricas que consideramos poco significativas para el modelo y explicamos los motivos:
...
```
    ...
    - En el caso de la variable Calificación, observamos en primer lugar la existencia de algunos valores poco prácticos para el modelo: "otro", "Ns.Nc." y "falta información".
    
    - Si bien se trata de sólo 84 valores, consideramos que la cuestión de la calificación y la formación de los encuestados puede ser capturada más nítidamente mediante el nivel educativo. (debatible)
...
```
    ...
    - Para el caso de la ocupación principal, consideramos que 1. la categoría "de otro tipo" no es lo suficientemente clara como para ser relevante y 2. la variable de sector/categoría captura el mismo elemento con mayor claridad. 
